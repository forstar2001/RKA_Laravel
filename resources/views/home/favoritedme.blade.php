 ...
 <section class="right-section">
                <div class="content">
                    ...
                    <div class="row m-t-40">
                        <?php if(!empty($favoritedme_info)){   
                             foreach($favoritedme_info as $fav_info){ 
                                 ?>
                        <div class="col-sm-6 col-md-4">
                            <div class="panel panel-default trainer-list">
                                <div class="panel-body p-30">
                                    ...
                                    <ul class="count-info">
                                        <li>
                                            <h6><?php echo isset($fav_info->favorite_me_distance) && $fav_info->favorite_me_distance != '' ?$fav_info->favorite_me_distance : 0 ;?> km</h6>
                                            <p>nearby</p>
                                        </li>
                                        <li>
                 ...
                 <?php  } 
                         ...
                         <div class='text text-danger'>No one has favorited you yet.</div>
              <?php       }  ?>
                   </div>
                </div>
            </section>
