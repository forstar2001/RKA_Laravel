                ...
                <div class="row">
                    <div class="col-md-5 col-sm-6 col-xs-12">
                        <div class="sign-box">
                            ...
                            <form action="{{ url("/User/VerifyEmail") }}" method="POST" class="m-t-30" id="login_form">
                                 {{ csrf_field() }}
                                <div class="form-group ">
                                    <div class="form-group-material textbox">
                                        <label class="control-label">Email</label>
                                        <input type="text" class="form-control" placeholder="Enter Registered Email Id" name="username" required>
                                    </div>
                                </div>
                                <a href="{{ url("/User/Login") }}" class="btn btn-grey pull-right">
                                    Return To Login
                                </a>
